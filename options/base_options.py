...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--loadSize', type=int, default=2000, help='scale images to this size')
        parser.add_argument('--fineSize', type=int, default=2000, help='then crop to this size')
        ...
        parser.add_argument('--w_gan', default=0.3, help='weight of the gan loss')
        ...
        parser.add_argument('--n_layers_patchD', type=int, default=3, help='number of layer in patch discriminator')
        parser.add_argument('--patchD', action='store_true',default='True', help='var boolean for using local discriminator ')
        parser.add_argument('--patchD_3',type=int, default=5,  help='var boolean for using local discriminator ')
        parser.add_argument('--patchSize',type=int, default=32,  help='var boolean for using local discriminator ')
        parser.add_argument('--use_wgan',type=int, default=8,  help='var boolean for using local discriminator ')
        parser.add_argument('--hybrid_loss', action='store_true', help='number of layer in patch discriminator')
        parser.add_argument('--D_P_times2', action='store_true', help='number of layer in patch discriminator')
