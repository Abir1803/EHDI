...
def define_D(input_nc, ndf, which_model_netD,
             n_layers_D=3, norm='batch', use_sigmoid=False, init_type='normal', gpu_ids=[], patch=False):
    netD = None
    norm_layer = get_norm_layer(norm_type=norm)
    ...
    elif which_model_netD == 'trans':
        netD = Discriminator(False, image_size=32, patch_size=4, input_channel=3, num_classes=1,
